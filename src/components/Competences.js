...
function Competences () {
    return (
        <Container id='competence' className='md-my-5 bg-light' fluid>
            <Row>
                <h2 className='fw-bold'>Mon Experience</h2><br />
                <p>Developpement web et Mobile</p>
            </Row>
            <Row className='align-items-center'>
                <Col md={8} className='md-p-5'>
                    <Row className='align-items-center bg-white ;d-p-2 m-2'>
                    ...
                    <Row className='align-items-center bg-white md-p-2 m-2'>
