    ...
    return (
        <Container id='apropos' className='md-my-5' fluid>
            ...
            <Row className='align-items-center'>
                <Col md={5} className='md-p-5'>
                    <Image src={coffee} width={'100%'} rounded />
                </Col>
                <Col md={7} className='md-p-5 align-items-center'>
                    <Row className='text-start md-m-3'>
                        <Col md={6}>
                    ...
                    <Row className='md-m-3'><Button type='submit' variant='dark' as='a'>Envoyer</Button></Row>
                </Col>
            </Row>
        </Container>
    );
